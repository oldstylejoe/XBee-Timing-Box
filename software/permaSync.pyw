...
#   backup log file.
#
#Changed 4/17 to identify the port compatibly with newer hardware and win 10. Also added
#    a log file (history_...) stored in the c:\datalogs\timing folder.
...
class portPulser(QtGui.QMainWindow):
    ...
    def mapPort(self):
        ...
        for p, desc, hwid in ports:
            ...
            if hwid.find("VID:PID") >= 0 or hwid.find("FTDI") >= 0:
                #print "gh0"
                self.port = p
